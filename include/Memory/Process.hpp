...
namespace CheatEngine::Memory {
    ...
    /**
     * @brief Create map that stores process names as keys and their corresponding process IDs as values.
     * This map is used to store the list of processes in the system.
     * 
